package pe.edu.cibertec.DAWI_VILLAGARAY_RIVAS_JOSUE.GABRIEL.service.impl;
...
import pe.edu.cibertec.DAWI_VILLAGARAY_RIVAS_JOSUE.GABRIEL.entity.Film;
import pe.edu.cibertec.DAWI_VILLAGARAY_RIVAS_JOSUE.GABRIEL.entity.Language;
import pe.edu.cibertec.DAWI_VILLAGARAY_RIVAS_JOSUE.GABRIEL.repository.FilmRepository;
import pe.edu.cibertec.DAWI_VILLAGARAY_RIVAS_JOSUE.GABRIEL.repository.LanguageRepository;
...
public class MaintenanceServiceImpl implements MaintenanceService {
    ...
    public Boolean deleteFilmById(int id) {
        if (filmRepository.existsById(id)) {
            filmRepository.deleteById(id); // La eliminación en cascada se manejará aquí
            return true;
        }
        return false; // Si el ID no existe, devolvemos false
    }
